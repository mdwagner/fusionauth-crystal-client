...
module FusionAuth
  ...
  class FusionAuthClient
    ...
    #
    # @param request [Hash] The action request that includes all of the information about the action being taken including
    #     the id of the action, any options and the duration (if applicable).
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def action_user(request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to determine which user to add to the family.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def add_user_to_family(family_id : String, request : Hash)
    ...
    # @param request [Hash] The action request that contains the information about the cancellation.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def cancel_action(action_id : String, request : Hash)
      start.uri("/api/user/action")
    ...
    # @param request [Hash] The change password request that contains all of the information used to change the password.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def change_password(change_password_id : String, request : Hash)
    ...
    # @param request [Hash] The change password request that contains all of the information used to change the password.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def change_password_by_identity(request : Hash)
      start.uri("/api/user/change-password")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
          .go()
    ...
    #
    # @param request [Hash] The request object that contains all of the information used to create the user comment.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def comment_on_user(request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the application.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_application(application_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the application role.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_application_role(application_id : String, role_id : String?, request : Hash)
      start.uri("/api/application")
          .url_segment(application_id)
          .url_segment("role")
          .url_segment(role_id)
    ...
    #
    # @param request [Hash] The request object that contains all of the information used to create the audit log entry.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_audit_log(request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the connector.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_connector(connector_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the consent.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_consent(consent_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the email template.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_email_template(email_template_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the family.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_family(family_id : String?, request : Hash)
      start.uri("/api/user/family")
          .url_segment(family_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
    ...
    # @param request [Hash] The request object that contains all of the information used to create the form.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_form(form_id : String?, request : Hash)
      start.uri("/api/form")
          .url_segment(form_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
    ...
    # @param request [Hash] The request object that contains all of the information used to create the form field.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_form_field(field_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the group.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_group(group_id : String?, request : Hash)
      start.uri("/api/group")
    ...
    #
    # @param request [Hash] The request object that contains all of the information used to create the group member(s).
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_group_members(request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the identity provider.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_identity_provider(identity_provider_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the lambda.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_lambda(lambda_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the tenant.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_tenant(tenant_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the theme.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_theme(theme_id : String?, request : Hash)
      start.uri("/api/theme")
    ...
    # @param request [Hash] The request object that contains all of the information used to create the user.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_user(user_id : String?, request : Hash)
      start.uri("/api/user")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
    ...
    # @param request [Hash] The request object that contains all of the information used to create the user action.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_user_action(user_action_id : String?, request : Hash)
      start.uri("/api/user-action")
    ...
    # @param request [Hash] The request object that contains all of the information used to create the user action reason.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_user_action_reason(user_action_reason_id : String?, request : Hash)
    ...
    # @param request [Hash] The request that contains the user consent information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_user_consent(user_consent_id : String?, request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the webhook.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def create_webhook(webhook_id : String?, request : Hash)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def deactivate_application(application_id : String)
      start.uri("/api/application")
          .url_segment(application_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def deactivate_user(user_id : String)
      start.uri("/api/user")
          .url_segment(user_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def deactivate_user_action(user_action_id : String)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .delete()
          .go()
    ...
    def deactivate_users(user_ids : Array)
    ...
    # @param user_ids [Array] The ids of the users to deactivate.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def deactivate_users_by_ids(user_ids : Array)
      start.uri("/api/user/bulk")
          .url_parameter("userId", user_ids)
          .url_parameter("dryRun", false)
          .url_parameter("hardDelete", false)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_application(application_id : String)
      start.uri("/api/application")
          .url_segment(application_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_application_role(application_id : String, role_id : String)
      start.uri("/api/application")
          .url_segment(application_id)
          .url_segment("role")
          .url_segment(role_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_connector(connector_id : String)
      start.uri("/api/connector")
          .url_segment(connector_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_consent(consent_id : String)
      start.uri("/api/consent")
          .url_segment(consent_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_email_template(email_template_id : String)
      start.uri("/api/email/template")
          .url_segment(email_template_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_form(form_id : String)
      start.uri("/api/form")
          .url_segment(form_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_form_field(field_id : String)
      start.uri("/api/form/field")
          .url_segment(field_id)
          .delete()
          .go()
    ...
    #
    # @param request [Hash] The member request that contains all of the information used to remove members to the group.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_group_members(request : Hash)
      start.uri("/api/group/member")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_identity_provider(identity_provider_id : String)
      start.uri("/api/identity-provider")
          .url_segment(identity_provider_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_lambda(lambda_id : String)
      start.uri("/api/lambda")
          .url_segment(lambda_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_registration(user_id : String, application_id : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_tenant(tenant_id : String)
      start.uri("/api/tenant")
          .url_segment(tenant_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_theme(theme_id : String)
      start.uri("/api/theme")
          .url_segment(theme_id)
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_user_action(user_action_id : String)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .url_parameter("hardDelete", true)
          .delete()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_user_action_reason(user_action_reason_id : String)
      start.uri("/api/user-action-reason")
          .url_segment(user_action_reason_id)
          .delete()
          .go()
    ...
    # @param request [Hash] The UserDeleteRequest.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def delete_users_by_query(request : Hash)
      start.uri("/api/user/bulk")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .delete()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def disable_two_factor(user_id : String, code : String)
    ...
    # @param request [Hash] The two factor enable request information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def enable_two_factor(user_id : String, request : Hash)
      start.uri("/api/user/two-factor")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def exchange_o_auth_code_for_access_token(code : String, client_id : String, client_secret : String?, redirect_uri : String)
      body = {
        "code" => code,
        "client_id" => client_id,
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def exchange_refresh_token_for_access_token(refresh_token : String, client_id : String?, client_secret : String?, scope : String?, user_code : String?)
      body = {
    ...
    #
    # @param request [Hash] The refresh request.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def exchange_refresh_token_for_jwt(request : Hash)
    ...
    # @param user_code [String] (Optional) The end-user verification code. This code is required if using this endpoint to approve the Device Authorization.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def exchange_user_credentials_for_access_token(username : String, password : String, client_id : String?, client_secret : String?, scope : String?, user_code : String?)
      body = {
        "username" => username,
        "password" => password,
        "client_id" => client_id,
    ...
    #
    # @param request [Hash] The request that contains the information about the user so that they can be emailed.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def forgot_password(request : Hash)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def generate_email_verification_id(email : String)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the key.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def generate_key(key_id : String?, request : Hash)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def generate_registration_verification_id(email : String, application_id : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def generate_two_factor_secret_using_jwt(encoded_jwt : String)
      start.uri("/api/two-factor/secret")
    ...
    # login systems.
    #
    # @param request [Hash] The third-party login request that contains information from the third-party login
    #     providers that FusionAuth uses to reconcile the user's account.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def identity_provider_login(request : Hash)
    ...
    # @param request [Hash] The request object that contains all of the information used to create the key.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def import_key(key_id : String?, request : Hash)
    ...
    #
    # @param request [Hash] The request that contains all of the information about all of the refresh tokens to import.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def import_refresh_tokens(request : Hash)
    ...
    #
    # @param request [Hash] The request that contains all of the information about all of the users to import.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def import_users(request : Hash)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def issue_jwt(application_id : String, encoded_jwt : String, refresh_token : String?)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def login_ping(user_id : String, application_id : String, caller_ip_address : String?)
      start.uri("/api/login")
          .url_segment(user_id)
          .url_segment(application_id)
    ...
    #
    # @param global [Bool] When this value is set to true all of the refresh tokens issued to the owner of the
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def logout(global : Bool, refresh_token : String?)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def lookup_identity_provider(domain : String)
    ...
    # @param request [Hash] The request that contains all of the information about the modification.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def modify_action(action_id : String, request : Hash)
      start.uri("/api/user/action")
          .url_segment(action_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param request [Hash] The passwordless login request that contains all of the information used to complete login.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def passwordless_login(request : Hash)
    ...
    # @param request [Hash] The request that contains just the new application information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_application(application_id : String, request : Hash)
      start.uri("/api/application")
          .url_segment(application_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new role information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_application_role(application_id : String, role_id : String, request : Hash)
      start.uri("/api/application")
          .url_segment(application_id)
          .url_segment("role")
          .url_segment(role_id)
    ...
    # @param request [Hash] The request that contains just the new connector information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_connector(connector_id : String, request : Hash)
      start.uri("/api/connector")
          .url_segment(connector_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new consent information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_consent(consent_id : String, request : Hash)
      start.uri("/api/consent")
          .url_segment(consent_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new email template information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_email_template(email_template_id : String, request : Hash)
      start.uri("/api/email/template")
          .url_segment(email_template_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new group information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_group(group_id : String, request : Hash)
      start.uri("/api/group")
          .url_segment(group_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request object that contains just the updated identity provider information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_identity_provider(identity_provider_id : String, request : Hash)
      start.uri("/api/identity-provider")
          .url_segment(identity_provider_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    #
    # @param request [Hash] The request that contains just the new integration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_integrations(request : Hash)
    ...
    # @param request [Hash] The request that contains just the new lambda information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_lambda(lambda_id : String, request : Hash)
      start.uri("/api/lambda")
          .url_segment(lambda_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new registration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_registration(user_id : String, request : Hash)
      start.uri("/api/user/registration")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    #
    # @param request [Hash] The request that contains just the new system configuration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_system_configuration(request : Hash)
    ...
    # @param request [Hash] The request that contains just the new tenant information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_tenant(tenant_id : String, request : Hash)
      start.uri("/api/tenant")
          .url_segment(tenant_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new theme information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_theme(theme_id : String, request : Hash)
      start.uri("/api/theme")
          .url_segment(theme_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new user information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_user(user_id : String, request : Hash)
      start.uri("/api/user")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new user action information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_user_action(user_action_id : String, request : Hash)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new user action reason information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_user_action_reason(user_action_reason_id : String, request : Hash)
      start.uri("/api/user-action-reason")
          .url_segment(user_action_reason_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @param request [Hash] The request that contains just the new user consent information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def patch_user_consent(user_consent_id : String, request : Hash)
      start.uri("/api/user/consent")
          .url_segment(user_consent_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .patch()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def reactivate_application(application_id : String)
      start.uri("/api/application")
          .url_segment(application_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def reactivate_user(user_id : String)
      start.uri("/api/user")
          .url_segment(user_id)
          .url_parameter("reactivate", true)
          .put()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def reactivate_user_action(user_action_id : String)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .url_parameter("reactivate", true)
          .put()
    ...
    #
    # @param request [Hash] The reconcile request that contains the data to reconcile the User.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def reconcile_jwt(request : Hash)
    ...
    # @param request [Hash] The request that optionally contains the User and must contain the UserRegistration.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def register(user_id : String?, request : Hash)
      start.uri("/api/user/registration")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def remove_user_from_family(family_id : String, user_id : String)
      start.uri("/api/user/family")
          .url_segment(family_id)
          .url_segment(user_id)
          .delete()
    ...
    # @param email [String] The email address of the user that needs a new verification email.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def resend_email_verification(email : String)
      start.uri("/api/user/verify-email")
          .url_parameter("email", email)
          .put()
          .go()
    ...
    # @param email [String] The email address of the user that needs a new verification email.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def resend_email_verification_with_application_template(application_id : String, email : String)
      start.uri("/api/user/verify-email")
          .url_parameter("applicationId", application_id)
          .url_parameter("email", email)
          .put()
    ...
    # @param application_id [String] The Id of the application to be verified.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def resend_registration_verification(email : String, application_id : String)
      start.uri("/api/user/verify-registration")
          .url_parameter("email", email)
          .url_parameter("applicationId", application_id)
          .put()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_action(action_id : String)
      start.uri("/api/user/action")
          .url_segment(action_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_actions(user_id : String)
      start.uri("/api/user/action")
          .url_parameter("userId", user_id)
          .get()
          .go()
    ...
    # @param user_id [String] The Id of the user to fetch the actions for.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_actions_preventing_login(user_id : String)
      start.uri("/api/user/action")
          .url_parameter("userId", user_id)
    ...
    # @param user_id [String] The Id of the user to fetch the actions for.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_active_actions(user_id : String)
      start.uri("/api/user/action")
          .url_parameter("userId", user_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_application(application_id : String?)
      start.uri("/api/application")
          .url_segment(application_id)
          .get()
          .go()
    ...
    #
    # @param audit_log_id [Int32] The Id of the audit log to retrieve.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_audit_log(audit_log_id : Int32)
      start.uri("/api/system/audit-log")
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_connector(connector_id : String)
      start.uri("/api/connector")
          .url_segment(connector_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_consent(consent_id : String)
      start.uri("/api/consent")
          .url_segment(consent_id)
          .get()
          .go()
    ...
    #
    # @param application_id [String] (Optional) The application id.
    # @param start [Int64] The start instant as UTC milliseconds since Epoch.
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_daily_active_report(application_id : String?, start : Int64, _end : Int64)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_email_template(email_template_id : String?)
      start.uri("/api/email/template")
          .url_segment(email_template_id)
          .get()
          .go()
    ...
    #
    # @param request [Hash] The request that contains the email template and optionally a locale to render it in.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_email_template_preview(request : Hash)
    ...
    #
    # @param event_log_id [Int32] The Id of the event log to retrieve.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_event_log(event_log_id : Int32)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_families(user_id : String)
      start.uri("/api/user/family")
          .url_parameter("userId", user_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_family_members_by_family_id(family_id : String)
      start.uri("/api/user/family")
          .url_segment(family_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_form(form_id : String)
      start.uri("/api/form")
          .url_segment(form_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_form_field(field_id : String)
      start.uri("/api/form/field")
          .url_segment(field_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_group(group_id : String)
      start.uri("/api/group")
          .url_segment(group_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_identity_provider(identity_provider_id : String?)
      start.uri("/api/identity-provider")
          .url_segment(identity_provider_id)
          .get()
          .go()
    ...
    # @param user_id [String] The Id of the user to fetch the actions for.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_inactive_actions(user_id : String)
      start.uri("/api/user/action")
          .url_parameter("userId", user_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_jwt_public_key(key_id : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_jwt_public_key_by_application_id(application_id : String)
      startAnonymous.uri("/api/jwt/public-key")
          .url_parameter("applicationId", application_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_key(key_id : String)
      start.uri("/api/key")
          .url_segment(key_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_lambda(lambda_id : String)
      start.uri("/api/lambda")
          .url_segment(lambda_id)
          .get()
          .go()
    ...
    #
    # @param type [Hash] The type of the lambda to return.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_lambdas_by_type(type : Hash)
      start.uri("/api/lambda")
    ...
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_login_report(application_id : String?, start : Int64, _end : Int64)
    ...
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_monthly_active_report(application_id : String?, start : Int64, _end : Int64)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_oauth_configuration(application_id : String)
      start.uri("/api/application")
          .url_segment(application_id)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_password_validation_rules_with_tenant_id(tenant_id : String)
      startAnonymous.uri("/api/tenant/password-validation-rules")
          .url_segment(tenant_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_pending_children(parent_email : String)
    ...
    #
    # @param offset [Int32] The initial record. e.g. 0 is the last login, 100 will be the 100th most recent login.
    # @param limit [Int32] (Optional, defaults to 10) The number of records to retrieve.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_recent_logins(offset : Int32, limit : Int32)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_refresh_tokens(user_id : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_registration(user_id : String, application_id : String)
      start.uri("/api/user/registration")
          .url_segment(user_id)
          .url_segment(application_id)
          .get()
    ...
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_registration_report(application_id : String?, start : Int64, _end : Int64)
    ...
    # @param tenant_id [String] The Id of the tenant.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_tenant(tenant_id : String)
      start.uri("/api/tenant")
          .url_segment(tenant_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_theme(theme_id : String)
      start.uri("/api/theme")
          .url_segment(theme_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_action(user_action_id : String?)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_action_reason(user_action_reason_id : String?)
      start.uri("/api/user-action-reason")
          .url_segment(user_action_reason_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_by_change_password_id(change_password_id : String)
      start.uri("/api/user")
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_by_email(email : String)
      start.uri("/api/user")
          .url_parameter("email", email)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_by_login_id(login_id : String)
      start.uri("/api/user")
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_by_username(username : String)
      start.uri("/api/user")
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_by_verification_id(verification_id : String)
      start.uri("/api/user")
    ...
    # @param user_id [String] The Id of the user.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_comments(user_id : String)
      start.uri("/api/user/comment")
          .url_segment(user_id)
          .get()
          .go()
    ...
    # @param user_consent_id [String] The User consent Id
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_consent(user_consent_id : String)
      start.uri("/api/user/consent")
          .url_segment(user_consent_id)
          .get()
          .go()
    ...
    # @param user_id [String] The User's Id
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_consents(user_id : String)
      start.uri("/api/user/consent")
          .url_parameter("userId", user_id)
          .get()
          .go()
    ...
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_login_report(application_id : String?, user_id : String, start : Int64, _end : Int64)
      start.uri("/api/report/login")
          .url_parameter("applicationId", application_id)
          .url_parameter("userId", user_id)
          .url_parameter("start", start)
    ...
    # @param _end [Int64] The end instant as UTC milliseconds since Epoch.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_login_report_by_login_id(application_id : String?, login_id : String, start : Int64, _end : Int64)
      start.uri("/api/report/login")
          .url_parameter("applicationId", application_id)
          .url_parameter("loginId", login_id)
          .url_parameter("start", start)
    ...
    # @param limit [Int32] (Optional, defaults to 10) The number of records to retrieve.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_recent_logins(user_id : String, offset : Int32, limit : Int32)
      start.uri("/api/user/recent-login")
          .url_parameter("userId", user_id)
          .url_parameter("offset", offset)
          .url_parameter("limit", limit)
    ...
    # @param encoded_jwt [String] The encoded JWT (access token).
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_user_using_jwt(encoded_jwt : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def retrieve_webhook(webhook_id : String?)
      start.uri("/api/webhook")
          .url_segment(webhook_id)
          .get()
          .go()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def revoke_refresh_token(token : String?, user_id : String?, application_id : String?)
      start.uri("/api/jwt/refresh")
    ...
    # @param user_consent_id [String] The User Consent Id
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def revoke_user_consent(user_consent_id : String)
      start.uri("/api/user/consent")
          .url_segment(user_consent_id)
          .delete()
          .go()
    ...
    #
    # @param request [Hash] The search criteria and pagination information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def search_audit_logs(request : Hash)
    ...
    # @param request [Hash] The search criteria and pagination information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def search_event_logs(request : Hash)
    ...
    # @param request [Hash] The search criteria and pagination information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def search_login_records(request : Hash)
    ...
    # @param ids [Array] The user ids to search for.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def search_users_by_ids(ids : Array)
      start.uri("/api/user/search")
          .url_parameter("ids", ids)
          .get()
          .go()
    ...
    #
    # @param request [Hash] The search criteria and pagination constraints. Fields used: ids, query, queryString, numberOfResults, orderBy, startRow,
    #     and sortFields.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def search_users_by_query(request : Hash)
      start.uri("/api/user/search")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
          .go()
    ...
    def search_users_by_query_string(request : Hash)
      start.uri("/api/user/search")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .post()
          .go()
    ...
    # @param request [Hash] The send email request that contains all of the information used to send the email.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def send_email(email_template_id : String, request : Hash)
    ...
    #
    # @param request [Hash] The request object that contains the parent email.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def send_family_request_email(request : Hash)
    ...
    #
    # @param request [Hash] The passwordless send request that contains all of the information used to send an email containing a code.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def send_passwordless_code(request : Hash)
    ...
    #
    # @param request [Hash] The request object that contains all of the information used to send the code.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def send_two_factor_code(request : Hash)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def send_two_factor_code_for_login(two_factor_id : String)
    ...
    #     providers that FusionAuth uses to reconcile the user's account.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def start_identity_provider_login(request : Hash)
    ...
    #
    # @param request [Hash] The passwordless start request that contains all of the information used to begin the passwordless login request.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def start_passwordless_login(request : Hash)
    ...
    # @param request [Hash] The login request that contains the user credentials used to log them in.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def two_factor_login(request : Hash)
    ...
    #
    # @param application_id [String] The Id of the application to update.
    # @param request [Hash] The request that contains all of the new application information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_application(application_id : String, request : Hash)
      start.uri("/api/application")
          .url_segment(application_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @param application_id [String] The Id of the application that the role belongs to.
    # @param role_id [String] The Id of the role to update.
    # @param request [Hash] The request that contains all of the new role information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_application_role(application_id : String, role_id : String, request : Hash)
      start.uri("/api/application")
          .url_segment(application_id)
          .url_segment("role")
          .url_segment(role_id)
    ...
    #
    # @param connector_id [String] The Id of the connector to update.
    # @param request [Hash] The request object that contains all of the new connector information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_connector(connector_id : String, request : Hash)
      start.uri("/api/connector")
          .url_segment(connector_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param consent_id [String] The Id of the consent to update.
    # @param request [Hash] The request that contains all of the new consent information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_consent(consent_id : String, request : Hash)
      start.uri("/api/consent")
          .url_segment(consent_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param email_template_id [String] The Id of the email template to update.
    # @param request [Hash] The request that contains all of the new email template information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_email_template(email_template_id : String, request : Hash)
      start.uri("/api/email/template")
          .url_segment(email_template_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @param request [Hash] The request object that contains all of the new form information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_form(form_id : String, request : Hash)
      start.uri("/api/form")
          .url_segment(form_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @param request [Hash] The request object that contains all of the new form field information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_form_field(field_id : String, request : Hash)
      start.uri("/api/form/field")
          .url_segment(field_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param group_id [String] The Id of the group to update.
    # @param request [Hash] The request that contains all of the new group information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_group(group_id : String, request : Hash)
      start.uri("/api/group")
          .url_segment(group_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param identity_provider_id [String] The Id of the identity provider to update.
    # @param request [Hash] The request object that contains the updated identity provider.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_identity_provider(identity_provider_id : String, request : Hash)
      start.uri("/api/identity-provider")
          .url_segment(identity_provider_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param request [Hash] The request that contains all of the new integration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_integrations(request : Hash)
      start.uri("/api/integration")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
          .go()
    ...
    # @param request [Hash] The request that contains all of the new key information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_key(key_id : String, request : Hash)
      start.uri("/api/key")
          .url_segment(key_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param lambda_id [String] The Id of the lambda to update.
    # @param request [Hash] The request that contains all of the new lambda information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_lambda(lambda_id : String, request : Hash)
      start.uri("/api/lambda")
          .url_segment(lambda_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param user_id [String] The Id of the user whose registration is going to be updated.
    # @param request [Hash] The request that contains all of the new registration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_registration(user_id : String, request : Hash)
      start.uri("/api/user/registration")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param request [Hash] The request that contains all of the new system configuration information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_system_configuration(request : Hash)
      start.uri("/api/system-configuration")
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
          .go()
    ...
    #
    # @param tenant_id [String] The Id of the tenant to update.
    # @param request [Hash] The request that contains all of the new tenant information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_tenant(tenant_id : String, request : Hash)
      start.uri("/api/tenant")
          .url_segment(tenant_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param theme_id [String] The Id of the theme to update.
    # @param request [Hash] The request that contains all of the new theme information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_theme(theme_id : String, request : Hash)
      start.uri("/api/theme")
          .url_segment(theme_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param user_id [String] The Id of the user to update.
    # @param request [Hash] The request that contains all of the new user information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_user(user_id : String, request : Hash)
      start.uri("/api/user")
          .url_segment(user_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param user_action_id [String] The Id of the user action to update.
    # @param request [Hash] The request that contains all of the new user action information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_user_action(user_action_id : String, request : Hash)
      start.uri("/api/user-action")
          .url_segment(user_action_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    #
    # @param user_action_reason_id [String] The Id of the user action reason to update.
    # @param request [Hash] The request that contains all of the new user action reason information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_user_action_reason(user_action_reason_id : String, request : Hash)
      start.uri("/api/user-action-reason")
          .url_segment(user_action_reason_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @param request [Hash] The request that contains the user consent information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_user_consent(user_consent_id : String, request : Hash)
      start.uri("/api/user/consent")
          .url_segment(user_consent_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @param request [Hash] The request that contains all of the new webhook information.
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def update_webhook(webhook_id : String, request : Hash)
      start.uri("/api/webhook")
          .url_segment(webhook_id)
          .body_handler(FusionAuth::JSONBodyHandler.new(request))
          .put()
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def validate_device(user_code : String, client_id : String)
    ...
    # @param encoded_jwt [String] The encoded JWT (access token).
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def validate_jwt(encoded_jwt : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def verify_email(verification_id : String)
    ...
    # @return [FusionAuth::ClientResponse] The ClientResponse object.
    def verify_registration(verification_id : String)
